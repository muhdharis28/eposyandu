...
const WaliKaderForm = () => {
  ...
  const updateLogin = async(wali_id) => {
    try {
      ...
      // Only include foto_kk if uploadedFilePath is available
      if (uploadedFilePath) {
  ...
  const handleProvinsiWaliChange = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setDistrictsWali([]); // Reset districts and villages when province changes
        setVillagesWali([]);
      })
  ...
  const handleProvinsiWaliChangeDom = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setDistrictsWaliDom([]); // Reset districts and villages when province changes
        setVillagesWaliDom([]);
      })
  ...
  const handleRegencyWaliChange = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setVillagesWali([]); // Reset villages when regency changes
      })
  ...
  const handleRegencyWaliChangeDom = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setVillagesWaliDom([]); // Reset villages when regency changes
      })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id) {
        ...
        const wali = await createWali(updatedFormData);
                ...
                <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                      rows="1"/> {errors.alamat_ktp_wali && <p className="text-red-500 text-sm mt-1">{errors.alamat_ktp_wali}</p>}
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                      disabled={!regenciesWaliDom.length}>
                      <option value="">Pilih Kota</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                      disabled={!districtsWaliDom.length}>
                      <option value="">Pilih Kecamatan</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                      disabled={!villagesWaliDom.length}>
                      <option value="">Pilih Kelurahan</option>
