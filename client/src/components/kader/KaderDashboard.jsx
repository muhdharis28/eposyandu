// src/components/kader/KaderDashboard.jsx
import React from 'react';
import TopBar from './TopBar';
import SideBar from './SideBar';
import Dashboard from './Dashboard'; // Kader-specific dashboard content
    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="flex flex-grow transition-all duration-500 ease-in-out">
        ...
        <div className={`flex-1 bg-gray-100 p-6 transition-all duration-500 ease-in-out`}>
          <h1 className="text-3xl font-bold mb-4">Kader Dashboard</h1>
          <Dashboard />
        </div>
      </div>
    </div>
