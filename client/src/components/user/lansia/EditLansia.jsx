...
import {getLansiaById, updateLansia} from '../../LansiaService'; // Assume you have these services
...
const EditLansiaForm = () => {
  ...
  const [errors,
    setErrors] = useState({}); // State to handle validation errors
  ...
  useEffect(() => {
    ...
    const fetchLansiaDetails = async() => {
      try {
        const response = await getLansiaById(id); // Fetch the Lansia data by ID
  ...
  const validateForm = () => {
    ...
    if (!formData.no_kk_lansia) 
      newErrors.no_kk_lansia = 'Nomor KK is required';
    if (!formData.nik_lansia) 
      newErrors.nik_lansia = 'NIK is required';
    if (!formData.nama_lansia) 
      newErrors.nama_lansia = 'Nama Lansia is required';
    if (!formData.tempat_lahir_lansia) 
      newErrors.tempat_lahir_lansia = 'Tempat Lahir is required';
    if (!formData.tanggal_lahir_lansia) 
      newErrors.tanggal_lahir_lansia = 'Tanggal Lahir is required';
    if (!formData.jenis_kelamin_lansia) 
      newErrors.jenis_kelamin_lansia = 'Jenis Kelamin is required';
    if (!formData.alamat_ktp_lansia) 
      newErrors.alamat_ktp_lansia = 'Alamat KTP is required';
    ...
    return Object
      .keys(newErrors)
      .length === 0; // Returns true if no errors
  };
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      console.error('Error updating Lansia:', error);
    } finally {
      ...
      <div className="flex flex-grow transition-all duration-500 ease-in-out">
        ...
        <div
          ...
          <nav className="text-gray-600 mb-4">
            <Link to="/user-lansia" className="hover:underline">Lansia List</Link>
            &gt; Tambah Lansia
          </nav>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.no_kk_lansia && <p className="text-red-500 text-sm">{errors.no_kk_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.nik_lansia && <p className="text-red-500 text-sm">{errors.nik_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.nama_lansia && <p className="text-red-500 text-sm">{errors.nama_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.tempat_lahir_lansia && <p className="text-red-500 text-sm">{errors.tempat_lahir_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.tanggal_lahir_lansia && <p className="text-red-500 text-sm">{errors.tanggal_lahir_lansia}</p>}
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.alamat_ktp_lansia && <p className="text-red-500 text-sm">{errors.alamat_ktp_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.kelurahan_ktp_lansia && <p className="text-red-500 text-sm">{errors.kelurahan_ktp_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.kecamatan_ktp_lansia && <p className="text-red-500 text-sm">{errors.kecamatan_ktp_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.kota_ktp_lansia && <p className="text-red-500 text-sm">{errors.kota_ktp_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.provinsi_ktp_lansia && <p className="text-red-500 text-sm">{errors.provinsi_ktp_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.alamat_domisili_lansia && <p className="text-red-500 text-sm">{errors.alamat_domisili_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.kelurahan_domisili_lansia && <p className="text-red-500 text-sm">{errors.kelurahan_domisili_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.kecamatan_domisili_lansia && <p className="text-red-500 text-sm">{errors.kecamatan_domisili_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.kota_domisili_lansia && <p className="text-red-500 text-sm">{errors.kota_domisili_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.provinsi_domisili_lansia && <p className="text-red-500 text-sm">{errors.provinsi_domisili_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.no_hp_lansia && <p className="text-red-500 text-sm">{errors.no_hp_lansia}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"/> {errors.email_lansia && <p className="text-red-500 text-sm">{errors.email_lansia}</p>}
                </div>
                <div>
