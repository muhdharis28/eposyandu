...
import { useSidebarUser } from './SideBarContext'; // Sidebar context for toggling
import { useNavigate } from 'react-router-dom';

// Main User Dashboard Component
const UserDashboard = () => {
  const { isSidebarCollapsed, toggleSidebar } = useSidebarUser(); // Access sidebar state and toggler
