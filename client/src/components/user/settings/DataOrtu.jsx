      ...
      try {
        ...
        if (response.data.orangTuaDetail) {
          ...
          if (ortu.provinsi_ktp_ibu) {
            ...
            axios.get(`${import.meta.env.VITE_API_URL}/api/location/provinsi/${ortu.provinsi_ktp_ibu}/regencies`);
            setRegenciesIbu(regencyResponse.data);

            if (ortu.kota_ktp_ibu) {
              const districtResponse = await
              axios.get(`${import.meta.env.VITE_API_URL}/api/location/regencies/${ortu.kota_ktp_ibu}/districts`);
              setDistrictsIbu(districtResponse.data);

              if (ortu.kecamatan_ktp_ibu) {
                const villageResponse = await
                axios.get(`${import.meta.env.VITE_API_URL}/api/location/districts/${ortu.kecamatan_ktp_ibu}/villages`);
          ...
          if (ortu.provinsi_domisili_ibu) {
            ...
            axios.get(`${import.meta.env.VITE_API_URL}/api/location/provinsi/${ortu.provinsi_domisili_ibu}/regencies`);
            setRegenciesIbuDom(regencyDomResponse.data);

            if (ortu.kota_domisili_ibu) {
              const districtDomResponse = await
              axios.get(`${import.meta.env.VITE_API_URL}/api/location/regencies/${ortu.kota_domisili_ibu}/districts`);
              setDistrictsIbuDom(districtDomResponse.data);

              if (ortu.kecamatan_domisili_ibu) {
                const villageDomResponse = await
                axios.get(`${import.meta.env.VITE_API_URL}/api/location/districts/${ortu.kecamatan_domisili_ibu}/villages`);
          ...
          if (ortu.provinsi_ktp_ayah) {
            const regencyResponse = await
            axios.get(`${import.meta.env.VITE_API_URL}/api/location/provinsi/${ortu.provinsi_ktp_ayah}/regencies`);
            setRegenciesAyah(regencyResponse.data);

            if (ortu.kota_ktp_ayah) {
              const districtResponse = await
              axios.get(`${import.meta.env.VITE_API_URL}/api/location/regencies/${ortu.kota_ktp_ayah}/districts`);
              setDistrictsAyah(districtResponse.data);

              if (ortu.kecamatan_ktp_ayah) {
                const villageResponse = await
                axios.get(`${import.meta.env.VITE_API_URL}/api/location/districts/${ortu.kecamatan_ktp_ayah}/villages`);
          ...
          if (ortu.provinsi_domisili_ayah) {
            const regencyDomResponse = await
            axios.get(`${import.meta.env.VITE_API_URL}/api/location/provinsi/${ortu.provinsi_domisili_ayah}/regencies`);
            setRegenciesAyahDom(regencyDomResponse.data);

            if (ortu.kota_domisili_ayah) {
              const districtDomResponse = await
              axios.get(`${import.meta.env.VITE_API_URL}/api/location/regencies/${ortu.kota_domisili_ayah}/districts`);
              setDistrictsAyahDom(districtDomResponse.data);

              if (ortu.kecamatan_domisili_ayah) {
                const villageDomResponse = await
                axios.get(`${import.meta.env.VITE_API_URL}/api/location/districts/${ortu.kecamatan_domisili_ayah}/villages`);
        ...
        <div className="slide">
            <div>
              <div className="flex justify-between mt-4">
                ...
                <button onClick={nextStep} className="flex items-center bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500">
                  Data Ayah
        ...
        <div className="slide">
          <div>
            <div className="flex justify-between mt-4">
              ...
              <button onClick={prevStep} className="flex items-center bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500">
